(ns audio.governor-test
  (:require [clojure.test :refer [deftest testing is]]
            [audio.governor :as governor]))

(def clean-asset
  {:kind :asset :format "wav" :license :cc0 :title "a gentle mystery, folk strings"
...
(deftest ogg-is-allowed
  (testing "governor allows both declared out formats (wav primary, ogg secondary)"
